...
<div class="col-md-10 p-5" style="padding-top: 100px;">
      <h3><i class="fas fa-chalkboard-teacher"></i> Daftar Guru & Staff</h3>
      <hr>
      <br>
    ...
    <table class="table table-hover table-bordered" style="border-color: black;">
        <thead class="thead-dark" style=" color: white; border-color: black;" >
          <tr>
            ...
            <th scope="col" style="width: 500px; text-align: center;; border-color: black;border-bottom-width: 1px;vertical-align: middle;">Nama Guru & Staff</th>
            ...
            <th scope="col" style="width: 100px; text-align: center;border-color: black;border-bottom-width: 1px;vertical-align: middle;">No HP</th>
            <th scope="col" style="width: 400px; text-align: center;border-color: black;border-bottom-width: 1px;vertical-align: middle;">Jabatan</th>
        ...
        <tbody>
          <?php $nomor=1; ?>
          <?php $ambil=$koneksi->query("SELECT * FROM gurustaff"); ?>
          <?php while ($pecah = $ambil->fetch_assoc()){ ?>
          

          <tr>
            <th scope="row" style="text-align: center;"><?php echo '201600'. $pecah['id']; ?></th>
            <td><?php echo $pecah['nama']; ?> </td>
            <td style="text-align: center;"><?php echo $pecah['jenis_kelamin']; ?></td>
            <td style="text-align: center;"><?php echo $pecah['no_hp']; ?></td>
