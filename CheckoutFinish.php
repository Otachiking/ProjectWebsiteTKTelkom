...
<br>
    <h2 class="text-left mt-3" > Sejarah <small  style="ml-3" class="text-muted">TK Telkom Buah Batu</small></h2>
 <div class="content" style="height: 550px;width: cover;background-image:url(Base2.png); padding-top: 150px;">
  <div class="container" align="center" style="margin-left: 45px;">
      <h1 style="color:white; width: 1000px; padding-top-top: 100px; font-size: 50px;">Berikan Bantuan Kesehatan Untuk Sesama!</h1>
      <p style="color: white;width: 1000px;font-size: 30px" class="lead">#BersamaLawanCorona</p>
    
      <p style="width: 1000px;">
        <a href="https://kitabisa.com/campaign/bersamacegahcovid19" class="btn btn-danger my-2" style="font-size: 20px;border-radius: 20px;">Donasi Sekarang</a>
      </p>
