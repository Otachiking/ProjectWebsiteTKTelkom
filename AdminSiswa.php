...
<br><br><br><br>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Larry</td>
      <td>the Bird</td>
      <td>@twitter <button type="submit" text= "right">Beli</button></td>
    </tr>
    <tr>
      <th scope="row"></th>
      <td>Jacob</td>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-lg-4 col-xs-12 location">
      ...
      <p class="text-white-50">`<font size="2.5">Made with Love ❤️️🧡💛💙💜🖤& Hardworking⚔️ in Bandung, Asrama, School, Whatsapp, and Sleep. =)</font></p>
